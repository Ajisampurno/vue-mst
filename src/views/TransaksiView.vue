                ...
                <div class="card-body">
                    <form @submit.prevent="submitForm">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-2">
                                    ...
                                    <input type="text" id="noTransaksi" class="form-control form-control-sm"
                                        v-model="transaction.kode" required readonly />
                                </div>
                                <div class="mb-2">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="button" class="btn btn-success my-3" @click="showModal = true">
                                    ...
                                    <tr v-for="(item, index) in cartItems" :key="index">
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning btn-sm mx-1"
                                                @click="editCartItem(index)"><i class="bi bi-pencil"></i></button>
                                            <button type="button" class="btn btn-danger btn-sm mx-1"
                                                @click="removeFromCart(index)"><i class="bi bi-trash"></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="px-2">:</td>
                                                <td class="px-2">
                                                    <input v-model="summary.subtotal" type="text" class="form-table">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-2">:</td>
                                                <td class="px-2">
                                                    {{ new Intl.NumberFormat().format(summary.total_bayar) }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">{{ editIndex !== null ? 'Edit Item' : 'Add Item' }}</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-6">
                                        <label>Kode</label>
                                        <select v-model="cart.barang_id" class="form-control" style="width: 100%;"
                                        ...
                                        <div class="form-group">
                                            <label>Qty</label>
                                            <input v-model="cart.qty" type="number" class="form-control form-control-sm"
                                                min="1" @input="updateTotals">
                                        </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input v-model="cart.nama" type="text" class="form-control form-control-sm"
                                                readonly>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" @click="addToCart">Save changes</button>
                        </div>
