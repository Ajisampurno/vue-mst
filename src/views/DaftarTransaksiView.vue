            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-4">
                            <!-- Search Input -->
                            <input type="text" class="form-control mb-2" placeholder="Search" v-model="searchQuery" />
                        </div>
                        <div class="col-4">
                            <!-- Filter Tanggal -->
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in filteredTransactions" :key="item.id">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <button class="btn btn-warning btn-sm" @click="editTransaction(item)">
...
export default {
    ...
    methods: {
        ...
        editTransaction(item) {
            // Implement your logic to edit the transaction
